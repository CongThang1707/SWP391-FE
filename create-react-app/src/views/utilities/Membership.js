...
import {
  ...
  createMembership,
  updateMembership
} from '../../service/membership_services/get_membership.js';
...
const EnhancedTable = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await createMembership(newMembership.type.toUpperCase(), newMembership.price, newMembership.description);
                ...
                <TableRow key={membership.membershipId}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      color="primary"
                      size="small"
                      onClick={() => navigate(`/membership-detail/${membership.type}`)}
                    >
                      {' '}
                      Detail
                    </Button>
                    <Button variant="contained" color="warning" size="small" onClick={() => handleOpenUpdateDialog(membership)}>
                      Update
                    </Button>
                    <Button variant="contained" color="secondary" size="small" onClick={() => handleDeleteMembership(membership.type)}>
                      Delete{' '}
                    </Button>
                  </TableCell>
                </TableRow>
