...
const BookingDetail = () => {
  ...
  return (
    <div>
      ...
      <p><strong>Schedule Work:</strong> {booking.scheduleWork}</p>
      <p><strong>Booking Date:</strong> {booking.bookDate}</p>
      <p><strong>Comment:</strong> {booking.comment}</p>
      <p><strong>Status:</strong> <span style={statusStyle}>{booking.status}</span></p>
    </div>
  );
};
