            ...
            >
                <CardContent>
                    <Typography
                        variant="h4"
                        gutterBottom
                        sx={{ fontWeight: 'bold', color: '#1976d2', fontSize: '1.5rem' }}
                    >
                        💬 Comment Detail
                    </Typography>
                    <Divider sx={{ mb: 4 }} />
                    ...
                    <Grid container spacing={4}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Typography
                                variant="h5"
                                sx={{ mb: 3, fontWeight: 'bold', fontSize: '1rem' }}
                            >
                            ...
                            >
                                <PersonIcon sx={{ mr: 1 }} /> <strong>Parent Name: </strong>{' '}
                                {comment.fullName}
                            </Typography>
                            ...
                            >
                                <CalendarMonthIcon sx={{ mr: 1 }} /> <strong>Date:</strong>{' '}
                                {comment.date}
                            </Typography>
                        </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Box sx={{ mt: 4 }}>
                                ...
                                <Box sx={{ animation: 'fadeIn 1s' }}>
                                    {renderStatusChip(comment.status)}
                                </Box>
                            </Box>
                        </Grid>
                    </Grid>
                    ...
                    >
                        <Button
                            ...
                            disabled={
                                comment.status === 'COMPLETED' || comment.status === 'CANCELLED'
                            }
                        ...
                        <Button
                            ...
                            disabled={
                                comment.status === 'CANCELLED' || comment.status === 'PENDING'
                            }
