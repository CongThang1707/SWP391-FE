...
//       <div style={{ marginBottom: '20px', border: '1px solid #ecf0f1', borderRadius: '10px', padding: '15px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
...
//       {/* Section 3: Health Record with Chart and Table */}
